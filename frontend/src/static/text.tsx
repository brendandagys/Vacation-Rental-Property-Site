...
export const textData: TextData = {
  ...
  "main-landing-call-to-action": {
    [ELanguage.Dutch]:
      "Neem contact met ons op voor meer informatie over uw volgende vakantie in Spanje!",
    [ELanguage.English]:
      "Contact us for more information about your next Spain holiday!",
    [ELanguage.French]:
      "Contactez-nous pour plus d'informations sur vos prochaines vacances en Espagne !",
    [ELanguage.German]:
      "Kontaktieren Sie uns für weitere Informationen zu Ihrem nächsten Spanienurlaub!",
    [ELanguage.Spanish]:
      "¡Contáctenos para obtener más información sobre sus próximas vacaciones en España!",
  },
  "main-details-text": {
    [ELanguage.Dutch]: (
      <>
        <p>
          <TextStar /> Welkom op de website van Calaceite FRONTLINE Vistamar!{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> LOCATIE, LOCATIE, LOCATIE - Nerja en Torrox-Costa in de
          Costa <TextStar />
        </p>
        <p>
          <TextStar /> Dit is appartement #6132 in het eerste blok van het
          strand met een VOLLEDIG FRONTAAL 180° zuid/west gericht uitzicht op de
          Alboran Zee <TextStar />
        </p>
        <p>
          <TextStar /> KIJK DE GOLVEN overdag vanaf het grote zonnige terras en
          slaap 's nachts met het geluid van de golven <TextStar />
        </p>
      </>
    ),
    [ELanguage.English]: (
    ...
    [ELanguage.French]: (
      <>
        <p>
          <TextStar /> Bienvenue sur le site Web de Calaceite FRONTLINE Vistamar
          ! <TextStar />
        </p>
        <p>
          <TextStar /> EMPLACEMENT, EMPLACEMENT, EMPLACEMENT - Nerja et
          Torrox-Costa sur la Costa <TextStar />
        </p>
        <p>
          <TextStar /> Il s'agit de l'appartement n° 6132 dans le premier bloc
          de la plage avec une vue frontale à 180° sud/ouest sur la mer
          d'Alboran <TextStar />
        </p>
        <p>
          <TextStar /> REGARDEZ LES VAGUES pendant la journée depuis la grande
          terrasse ensoleillée et dormez au son des vagues la nuit <TextStar />
        </p>
      </>
    ),
    [ELanguage.German]: (
      <>
        <p>
          <TextStar /> Willkommen auf der Calaceite FRONTLINE Vistamar-Website!{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> LAGE, LAGE, LAGE – Nerja und Torrox-Costa an der Costa{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Dies ist Apartment Nr. 6132 im ersten Block zum Strand
          mit VOLLSTÄNDIGEM FRONTALEN 180°-Meerblick nach Süd/West auf das
          Alboran-Meer <TextStar />
        </p>
        <p>
          <TextStar /> Beobachten Sie tagsüber die Wellen von der großen,
          sonnigen Terrasse aus und schlafen Sie nachts beim Rauschen der Wellen
          ein <TextStar />
        </p>
      </>
    ),
    [ELanguage.Spanish]: (
      <>
        <p>
          <TextStar /> ¡Bienvenidos al sitio web de Vistamar en PRIMERA LÍNEA de
          Calaceite! <TextStar />
        </p>
        <p>
          <TextStar /> UBICACIÓN, UBICACIÓN, UBICACIÓN - Nerja y Torrox-Costa en
          la Costa <TextStar />
        </p>
        <p>
          <TextStar /> Este es el apartamento n.° 6132 en el primer bloque de la
          playa con una vista frontal de 180° al mar de Alborán orientada al
          sur/oeste <TextStar />
        </p>
        <p>
          <TextStar /> OBSERVE LAS OLAS durante el día desde la gran terraza
          soleada y duerma con el sonido de las olas por la noche <TextStar />
        </p>
      </>
    ),
  },
  ...
  "calendar-subtitle": {
    [ELanguage.Dutch]:
      "Selecteer hieronder een datumbereik om een onderzoek te starten",
    [ELanguage.English]: "Select a date range below to begin an inquiry",
    [ELanguage.French]:
      "Sélectionnez une plage de dates ci-dessous pour commencer une enquête",
    [ELanguage.German]:
      "Wählen Sie unten einen Datumsbereich aus, um eine Anfrage zu starten",
    [ELanguage.Spanish]:
      "Seleccione un rango de fechas a continuación para comenzar una consulta",
  },
  "calendar-month-1": {
  ...
  "details-content": {
    [ELanguage.Dutch]: (
      <div className="details-text">
        <p>
          <TextStar /> GRATIS - Inbegrepen in de prijs:
        </p>
        <ul>
        ...
        <p>
          <TextStar /> 65" Flat SCREEN SMART-televisie met NETFLIX & 100's
          kanalen (Frans, Duits, Engels, Spaans) <TextStar />
        </p>
        <p>
          <TextStar /> LOP 5 minuten naar het privézandstrand EL PENONCILLO. Het
          El Penoncillo Playa ligt op 200 meter afstand en heeft
          strandrestaurants die dagelijks verse vis en zeevruchten serveren{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> TWEE grote luxe BUITENBADEN met prachtige groene tuinen.
          Er zijn ligstoelen, parasols en twee ondiepe zwembaden voor kinderen.
          Zwembaden zijn omheind en worden bewaakt met een
          beveiligingskaartsysteem om privacy en exclusiviteit te garanderen{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> WASMACHINE en DROGER bevinden zich in het appartement
          voor uw gemak <TextStar />
        </p>
        <p>
          <TextStar /> GRATIS Privé PARKEERPLAATS voor uw auto in een overdekte
          garage behorend bij het appartement met een lift op 10 meter afstand
          om u binnen enkele minuten rechtstreeks naar uw appartement te brengen{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> 40 minuten van de luchthaven van Malaga <TextStar />
        </p>
        <p>
          <TextStar /> Nieuw gebouwd RESORTcomplex met graniet, gepolijste
          marmeren vloeren, kwaliteitsfittingen en Bosch-apparatuur. Het
          appartement heeft 2 slaapkamers, 2 badkamers en een volledig
          uitgeruste keuken. Het bevindt zich op de bovenste verdieping (met
          lift) <TextStar />
        </p>
        <p>
          <TextStar /> Spannende TOERISTISCHE ATTRACTIES om dagelijks in elke
          richting te bezoeken <TextStar />
        </p>
        <p>
          <TextStar /> Dit is een zeer goed onderhouden en VOLLEDIG uitgeruste
          woning. Het heeft alles wat een gast ooit nodig zou kunnen hebben om
          een heerlijke vakantie te garanderen <TextStar />
        </p>
        <p>
          <TextStar /> Gebruik van een grote parasol en strandmatten{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Perfect voor een romantische, pensioen- of
          familievakantie. Gegarandeerd het hele jaar door Spaanse zonneschijn{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Langetermijnverhuur is welkom. Geniet van uw
          wintermaanden in de zon <TextStar />
        </p>

        <div className="text-center font-sm pt-5 pb-3">
          <p>
            <i>
              Nog andere vragen? Neem contact met ons op en we helpen u graag
              verder.
            </i>
          </p>
        </div>
    ...
    [ELanguage.English]: (
      <div className="details-text">
        ...
        <p>
          ...
          gardens. There are sun loungers, sun shade and two shallow pools for
          children. Pools are gated and monitored with a security card pass
        ...
        <p>
          <TextStar /> Exciting TOURIST ATTRACTIONS to visit daily in every
          direction <TextStar />
        </p>
        <p>
        ...
        <p>
          <TextStar /> Use of a large beach umbrella & beach mats <TextStar />
        </p>
        <p>
        ...
        <div className="text-center font-sm pt-5 pb-3">
          <p>
            <i>
              Any other questions? Please contact us and we'd be happy to help.
            </i>
          </p>
        </div>
      </div>
    ...
    [ELanguage.French]: (
      <div className="details-text">
        <p>
          <TextStar /> GRATUIT - Inclus dans le prix :
        </p>
        <ul>
        ...
        <p>
          <TextStar /> Télévision SMART ÉCRAN PLAT 65" avec NETFLIX et des
          centaines de chaînes (françaises, allemandes, anglaises, espagnoles){" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> À 5 minutes à pied de la plage de sable privée EL
          PENONCILLO. La plage El Penoncillo est à 200 mètres et dispose de
          restaurants de plage qui proposent une cuisine de poisson frais et de
          fruits de mer tous les jours <TextStar />
        </p>
        <p>
          <TextStar /> DEUX grandes PISCINES EXTÉRIEURES luxueuses avec de beaux
          jardins verdoyants. Il y a des chaises longues, un parasol et deux
          piscines peu profondes pour les enfants. Les piscines sont fermées et
          surveillées par un système de carte de sécurité pour assurer
          l'intimité et l'exclusivité <TextStar />
        </p>
        <p>
          <TextStar /> LA MACHINE À LAVER et LA SÈCHE-LINGE sont à l'intérieur
          de l'appartement pour votre confort <TextStar />
        </p>
        <p>
          <TextStar /> PARKING privé GRATUIT pour votre voiture dans un parking
          couvert garage appartenant à l'appartement avec un ascenseur à 10
          mètres pour vous emmener directement à votre appartement en quelques
          minutes <TextStar />
        </p>
        <p>
          <TextStar /> 40 minutes de l'aéroport de Malaga <TextStar />
        </p>
        <p>
          <TextStar /> Complexe RESORT récemment construit avec granit, sols en
          marbre poli, équipements de qualité et appareils Bosch. L'appartement
          dispose de 2 chambres, 2 salles de bains et une cuisine entièrement
          équipée. Il est au dernier étage (avec ascenseur) <TextStar />
        </p>
        <p>
          <TextStar /> ATTRIBUTIONS TOURISTIQUES passionnantes à visiter
          quotidiennement dans toutes les directions <TextStar />
        </p>
        <p>
          <TextStar /> C'est une propriété très bien entretenue et ENTIÈREMENT
          équipée. Elle a tout ce dont un client pourrait avoir besoin pour
          assurer de merveilleuses vacances <TextStar />
        </p>
        <p>
          <TextStar /> Utilisation d'un grand parasol et de tapis de plage{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Parfait pour des vacances romantiques, de retraite ou en
          famille. Soleil espagnol garanti toute l'année <TextStar />
        </p>
        <p>
          <TextStar /> Les locations à long terme sont les bienvenues. Profitez
          de vos mois d'hiver au soleil <TextStar />
        </p>

        <div className="text-center font-sm pt-5 pb-3">
          <p>
            <i>
              D'autres questions ? Veuillez nous contacter et nous serons
    ...
    [ELanguage.German]: (
      <div className="details-text">
        <p>
          <TextStar /> KOSTENLOS – Im Preis inbegriffen:
        </p>
        <ul>
        ...
        <p>
          <TextStar /> 65-Zoll-Flachbildfernseher mit NETFLIX und Hunderten von
          Kanälen (Französisch, Deutsch, Englisch, Spanisch) <TextStar />
        </p>
        <p>
          <TextStar /> 5 Gehminuten zum privaten Sandstrand EL PENONCILLO. Der
          Strand El Penoncillo ist 200 Meter entfernt und bietet
          Strandrestaurants, die täglich frischen Fisch und Meeresfrüchte
          anbieten <TextStar />
        </p>
        <p>
          <TextStar /> ZWEI große, luxuriöse AUSSENPOOLS mit wunderschönen
          grünen Gärten. Es gibt Sonnenliegen, Sonnenschirme und zwei flache
          Pools für Kinder. Die Pools sind eingezäunt und werden mit einem
          Sicherheitskarten-Passsystem überwacht, um Privatsphäre und
          Exklusivität zu gewährleisten <TextStar />
        </p>
        <p>
          <TextStar /> WASCHMASCHINE und TROCKNER befinden sich für Ihre
          Bequemlichkeit im Apartment <TextStar />
        </p>
        <p>
          <TextStar /> KOSTENLOSER privater PARKPLATZ für Ihr Auto in einer
          überdachten Garage gehört zur Wohnung mit einem Aufzug in 10 Metern
          Entfernung, der Sie in wenigen Minuten direkt zu Ihrer Wohnung bringt{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> 40 Minuten vom Flughafen Malaga entfernt <TextStar />
        </p>
        <p>
          <TextStar /> Neu gebauter RESORT-Komplex mit Granit, polierten
          Marmorböden, hochwertigen Armaturen und Bosch-Geräten. Die Wohnung hat
          2 Schlafzimmer, 2 Badezimmer und eine voll ausgestattete Küche. Sie
          befindet sich im obersten Stockwerk (mit Aufzug) <TextStar />
        </p>
        <p>
          <TextStar /> Spannende TOURISTENATTRAKTIONEN, die man täglich in alle
          Richtungen besuchen kann <TextStar />
        </p>
        <p>
          <TextStar /> Dies ist ein sehr gepflegtes und VOLL ausgestattetes
          Anwesen. Es hat alles, was ein Gast jemals brauchen könnte, um einen
          wundervollen Urlaub zu gewährleisten <TextStar />
        </p>
        <p>
          <TextStar /> Nutzung eines großen Sonnenschirms und Strandmatten{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Perfekt für einen romantischen Urlaub, einen Ruhestand
          oder einen Familienurlaub. Garantierter spanischer Sonnenschein das
          ganze Jahr über <TextStar />
        </p>
        <p>
          <TextStar /> Langzeitmieten sind willkommen. Genießen Sie Ihre
          Wintermonate in der Sonne <TextStar />
        </p>

        <div className="text-center font-sm pt-5 pb-3">
          <p>
            <i>
              Noch Fragen? Bitte kontaktieren Sie uns und wir helfen Ihnen gerne
              weiter.
            </i>
          </p>
        </div>
    ...
    [ELanguage.Spanish]: (
      <div className="details-text">
        <p>
          <TextStar /> GRATIS - Incluido en el precio:
        </p>
        <ul>
        ...
        <p>
          <TextStar /> Televisión SMART DE PANTALLA PLANA DE 65" con NETFLIX y
          cientos de canales (francés, alemán, inglés, español) <TextStar />
        </p>
        <p>
          <TextStar /> CAMINE 5 minutos hasta la PLAYA PRIVADA DE ARENA EL
          PENONCILLO. La Playa El Peñóncillo está a 200 metros y tiene
          restaurantes de playa que ofrecen pescado fresco y mariscos todos los
          días <TextStar />
        </p>
        <p>
          <TextStar /> DOS PISCINAS AL AIRE LIBRE grandes y lujosas con hermosos
          jardines verdes. Hay tumbonas, sombrillas y dos piscinas poco
          profundas para niños. Las piscinas están cerradas y monitoreadas con
          un sistema de pase de tarjeta de seguridad para garantizar la
          privacidad y la exclusividad <TextStar />
        </p>
        <p>
          <TextStar /> LA LAVADORA y la SECADORA están dentro del apartamento
          para su comodidad <TextStar />
        </p>
        <p>
          <TextStar /> ESTACIONAMIENTO privado GRATUITO para Su coche en un
          garaje cubierto perteneciente al apartamento con un ascensor a 10
          metros de distancia para llevarlo directamente a su apartamento en
          minutos <TextStar />
        </p>
        <p>
          <TextStar /> A 40 minutos del aeropuerto de Málaga <TextStar />
        </p>
        <p>
          <TextStar /> Complejo RESORT de nueva construcción con granito, suelos
          de mármol pulido, accesorios de calidad y electrodomésticos Bosch. El
          apartamento tiene 2 dormitorios, 2 baños y una cocina completamente
          equipada. Está en un piso superior (con ascensor) <TextStar />
        </p>
        <p>
          <TextStar /> Atractivos turísticos emocionantes para visitar a diario
          en todas las direcciones <TextStar />
        </p>
        <p>
          <TextStar /> Esta es una propiedad muy bien mantenida y TOTALMENTE
          equipada. Tiene todo lo que un huésped pueda necesitar para garantizar
          unas maravillosas vacaciones <TextStar />
        </p>
        <p>
          <TextStar /> Uso de una gran sombrilla de playa y colchonetas de playa{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Perfecto para unas vacaciones románticas, de jubilación o
          familiares. Sol español garantizado todo el año <TextStar />
        </p>
        <p>
          <TextStar /> Alquileres a largo plazo son bienvenidos. Disfrute de sus
          meses de invierno bajo el sol <TextStar />
        </p>

        <div className="text-center font-sm pt-5 pb-3">
          <p>
            <i>
              ¿Alguna otra pregunta? Por favor, póngase en contacto con nosotros
  ...
  "attractions-content": {
    [ELanguage.Dutch]: (
      <div className="attractions-text">
        <p>
          <TextStar /> Het dorp Nerja en het beroemde Balkon van Europa{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> De Nerja Kristalgrotten <TextStar />
        </p>
        <p>
          <TextStar /> De Torrox-Costa Paseo <TextStar />
        </p>
        <p>
          <TextStar /> De Buitenstraatmarkten - in verschillende dorpen elke
          ochtend van 10.00 tot 14.00 uur <TextStar />
        </p>
        <p>
          <TextStar /> De Rio Chillar Rivierwandeling <TextStar />
        </p>
        <p>
          <TextStar /> De dorpen Frigiliana en Competa <TextStar />
        </p>
        <p>
          <TextStar /> Het Alhambra Kasteel in Granada en het Sierra Nevada
          Bergskistation <TextStar />
        </p>
        <p>
          <TextStar /> De Oude Stad van Malaga en de Caminito del Rey Wandeling{" "}
          <TextStar />
        </p>
      </div>
    ),
    [ELanguage.English]: (
      <div className="attractions-text">
        <p>
          <TextStar /> The <strong>Village</strong> of <strong>Nerja</strong>{" "}
          and the famous <strong>Balcony of Europe</strong> <TextStar />
        </p>
        <p>
          <TextStar /> The <strong>Nerja Crystal Caves</strong> <TextStar />
        </p>
        <p>
          <TextStar /> The <strong>Torrox-Costa Paseo</strong> <TextStar />
        </p>
        <p>
          <TextStar /> The <strong>Outdoor Street Markets</strong> - in
          different villages every morning from 10am to 2pm <TextStar />
        </p>
        <p>
          <TextStar /> The <strong>Rio Chillar River Walk</strong> <TextStar />
        </p>
        <p>
          <TextStar /> The <strong>Villages</strong> of{" "}
          <strong>Frigiliana</strong> and <strong>Competa</strong> <TextStar />
        </p>
        <p>
          <TextStar /> The <strong>Alhambra Castle in Granada</strong> and the{" "}
          <strong>Sierra Nevada Mountain Ski Station</strong> <TextStar />
        </p>
        <p>
          <TextStar /> The <strong>Old City of Malaga</strong> and the{" "}
          <strong>Caminito del Rey Hike</strong> <TextStar />
        </p>
      </div>
    ),
    [ELanguage.French]: (
      <div className="attractions-text">
        <p>
          <TextStar /> Le village de Nerja et le célèbre Balcon de l'Europe{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Les grottes de cristal de Nerja <TextStar />
        </p>
        <p>
          <TextStar /> La promenade Torrox-Costa <TextStar />
        </p>
        <p>
          <TextStar /> Les marchés de rue en plein air - dans différents
          villages chaque matin de 10h à 14h <TextStar />
        </p>
        <p>
          <TextStar /> La promenade sur la rivière Rio Chillar <TextStar />
        </p>
        <p>
          <TextStar /> Les villages de Frigiliana et Competa <TextStar />
        </p>
        <p>
          <TextStar /> Le château de l'Alhambra à Grenade et la station de ski
          de la Sierra Nevada <TextStar />
        </p>
        <p>
          <TextStar /> La vieille ville de Malaga et la randonnée du Caminito
          del Rey <TextStar />
        </p>
      </div>
    ),
    [ELanguage.German]: (
      <div className="attractions-text">
        <p>
          <TextStar /> Das Dorf Nerja und der berühmte Balkon Europas{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Die Kristallhöhlen von Nerja <TextStar />
        </p>
        <p>
          <TextStar /> Der Torrox-Costa Paseo <TextStar />
        </p>
        <p>
          <TextStar /> Die Straßenmärkte im Freien – jeden Morgen von 10 bis 14
          Uhr in verschiedenen Dörfern <TextStar />
        </p>
        <p>
          <TextStar /> Der Spaziergang am Fluss Rio Chillar <TextStar />
        </p>
        <p>
          <TextStar /> Die Dörfer Frigiliana und Competa <TextStar />
        </p>
        <p>
          <TextStar /> Die Alhambra in Granada und die Skistation im Gebirge
          Sierra Nevada <TextStar />
        </p>
        <p>
          <TextStar /> Die Altstadt von Malaga und die Wanderung auf dem
          Caminito del Rey <TextStar />
        </p>
      </div>
    ),
    [ELanguage.Spanish]: (
      <div className="attractions-text">
        <p>
          <TextStar /> El pueblo de Nerja y el famoso Balcón de Europa{" "}
          <TextStar />
        </p>
        <p>
          <TextStar /> Las cuevas de cristal de Nerja <TextStar />
        </p>
        <p>
          <TextStar /> El paseo de Torrox-Costa <TextStar />
        </p>
        <p>
          <TextStar /> Los mercadillos al aire libre, en diferentes pueblos
          todas las mañanas de 10:00 a 14:00 horas <TextStar />
        </p>
        <p>
          <TextStar /> El paseo fluvial del río Chillar <TextStar />
        </p>
        <p>
          <TextStar /> Los pueblos de Frigiliana y Cómpeta <TextStar />
        </p>
        <p>
          <TextStar /> El castillo de la Alhambra en Granada y la estación de
          esquí de Sierra Nevada <TextStar />
        </p>
        <p>
          <TextStar /> El casco antiguo de Málaga y la ruta de senderismo del
          Caminito del Rey <TextStar />
        </p>
      </div>
    ),
  ...
  "inquiry-modal-email-helper-text": {
    ...
    [ELanguage.French]:
      "Nous ne partagerons jamais vos informations avec qui que ce soit d'autre.",
  ...
  "inquiry-modal-message-placeholder-1": {
    [ELanguage.Dutch]:
      "Ik ben geïnteresseerd in het boeken van deze accommodatie",
    [ELanguage.English]: "I am interested in booking this property",
    [ELanguage.French]:
      "Je suis intéressé par la réservation de cette propriété",
  ...
  "inquiry-modal-message-placeholder-2": {
    [ELanguage.Dutch]:
      "Neem contact met mij op met wat aanvullende informatie.",
    [ELanguage.English]: "Please contact me with some additional information.",
    [ELanguage.French]:
      "S'il vous plaît contactez-moi avec quelques informations supplémentaires.",
    [ELanguage.German]:
      "Bitte kontaktieren Sie mich mit weiteren Informationen.",
    [ELanguage.Spanish]:
      "Por favor, póngase en contacto conmigo con alguna información adicional.",
  },
  ...
  "inquiry-modal-linens-disclaimer": {
    [ELanguage.Dutch]:
      "Bij elk verblijf zijn twee linnenpakketten gratis inbegrepen.",
    [ELanguage.English]:
      "Two linen packages are included free with every stay.",
    [ELanguage.French]:
      "Deux paquets de linge sont inclus gratuitement avec chaque séjour.",
    [ELanguage.German]:
      "Bei jedem Aufenthalt sind zwei Wäschepakete kostenlos inbegriffen.",
    [ELanguage.Spanish]:
      "Se incluyen dos paquetes de ropa de cama gratis con cada estadía.",
  },
  ...
  "post-submission-modal-2": {
    [ELanguage.Dutch]:
      "We nemen spoedig contact met u op met meer details over uw reservering.",
    [ELanguage.English]:
      "We will contact you shortly with more details about your reservation.",
    [ELanguage.French]:
      "Nous vous contacterons sous peu avec plus de détails sur votre réservation.",
    [ELanguage.German]:
      "Wir werden Sie in Kürze mit weiteren Einzelheiten zu Ihrer Reservierung kontaktieren.",
    [ELanguage.Spanish]:
      "Nos pondremos en contacto con usted en breve con más detalles sobre su reserva.",
  },
  "post-submission-modal-3": {
    ...
    [ELanguage.Spanish]:
      "También puede comunicarse con nosotros en cualquier momento en",
  },
  ...
  "guest-book-title": {
    [ELanguage.Dutch]: "Gastenboek",
    [ELanguage.English]: "Guest Book",
    [ELanguage.French]: "Livre d'or",
    [ELanguage.German]: "Gästebuch",
    [ELanguage.Spanish]: "Libro de visitas",
  },
  "testimonial-form-name": {
    [ELanguage.Dutch]: "Naam of initialen",
    [ELanguage.English]: "Name or initials",
    [ELanguage.French]: "Nom ou initiales",
    [ELanguage.German]: "Name oder Initialen",
    [ELanguage.Spanish]: "Nombre o iniciales",
  },
  "testimonial-form-name-placeholder": {
    [ELanguage.Dutch]: "bijvoorbeeld Jane D. of JD",
    [ELanguage.English]: "e.g. Jane D. or JD",
    [ELanguage.French]: "par exemple Jane D. ou JD",
    [ELanguage.German]: "z. B. Jane D. oder JD",
    [ELanguage.Spanish]: "p. ej. Jane D. o JD",
  },
  "testimonial-form-title": {
    [ELanguage.Dutch]: "Titel van de recensie",
    [ELanguage.English]: "Review title",
    [ELanguage.French]: "Titre de l'avis",
    [ELanguage.German]: "Titel der Rezension",
    [ELanguage.Spanish]: "Título de la reseña",
  },
  "testimonial-form-comment": {
    [ELanguage.Dutch]: "Reacties",
    [ELanguage.English]: "Comments",
    [ELanguage.French]: "Commentaires",
    [ELanguage.German]: "Kommentare",
    [ELanguage.Spanish]: "Comentarios",
  },
  "testimonial-form-rating": {
    [ELanguage.Dutch]: "Beoordeling",
    [ELanguage.English]: "Rating",
    [ELanguage.French]: "Notation",
    [ELanguage.German]: "Bewertung",
    [ELanguage.Spanish]: "Clasificación",
  },
  "testimonial-form-submit": {
    [ELanguage.Dutch]: "Indienen",
    [ELanguage.English]: "Submit",
    [ELanguage.French]: "Soumettre",
    [ELanguage.German]: "Einreichen",
    [ELanguage.Spanish]: "Entregar",
  },
  "testimonial-form-characters-left": {
    [ELanguage.Dutch]: "tekens over",
    [ELanguage.English]: "characters left",
    [ELanguage.French]: "caractères restants",
    [ELanguage.German]: "Zeichen übrig",
    [ELanguage.Spanish]: "caracteres restantes",
  },
  "testimonial-form-success": {
    [ELanguage.Dutch]: "Bedankt! Uw beoordeling is verzonden.",
    [ELanguage.English]: "Thank you! Your review was submitted.",
    [ELanguage.French]: "Merci ! Votre avis a été soumis.",
    [ELanguage.German]: "Vielen Dank! Ihre Bewertung wurde übermittelt.",
    [ELanguage.Spanish]: "¡Gracias! Tu reseña fue enviada.",
  },
  "testimonial-form-error": {
    [ELanguage.Dutch]: "Het is niet gelukt om in te dienen",
    [ELanguage.English]: "Failed to submit",
    [ELanguage.French]: "Échec de la soumission",
    [ELanguage.German]: "Senden fehlgeschlagen",
    [ELanguage.Spanish]: "No se pudo enviar",
  },
  "testimonials-stars": {
    [ELanguage.Dutch]: "Sterren",
    [ELanguage.English]: "Stars",
    [ELanguage.French]: "Étoiles",
    [ELanguage.German]: "Sterne",
    [ELanguage.Spanish]: "Estrellas",
  },
  "testimonials-star": {
    [ELanguage.Dutch]: "Sterren",
    [ELanguage.English]: "Star",
    [ELanguage.French]: "Étoile",
    [ELanguage.German]: "Stern",
    [ELanguage.Spanish]: "Estrella",
  },
  "testimonials-guest": {
    [ELanguage.Dutch]: "Gast",
    [ELanguage.English]: "Guest",
    [ELanguage.French]: "Invité",
    [ELanguage.German]: "Gast",
    [ELanguage.Spanish]: "Invitado",
  },
};
