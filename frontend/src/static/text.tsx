...
export const textData: TextData = {
  ...
  'inquiry-modal-last-label': {
    [ELanguage.Dutch]: 'Laatst',
    [ELanguage.English]: 'Last',
    [ELanguage.French]: 'Dernier',
    [ELanguage.German]: 'Zuletzt',
    [ELanguage.Spanish]: 'Último',
  },
  'inquiry-modal-first-label': {
    [ELanguage.Dutch]: 'Eerst',
    [ELanguage.English]: 'First',
    [ELanguage.French]: "D'abord",
    [ELanguage.German]: 'Erste',
    [ELanguage.Spanish]: 'Primero',
  },
